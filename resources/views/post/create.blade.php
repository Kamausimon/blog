...
<Body class="bg-sky-500">
    ...
    <div class="container mx-auto px-4 py-5">
        ...
        <div class="bg-white p-10 rounded shadow">
            ...
            <form action="">
                <label for="postContent" class="block mb-2 font-bold text-gray-700">Content:</label>
                <textarea name="postContent" id="postContent" rows="6" cols="50" class="w-full p-2 border rounded shadow-inner"></textarea>
                <br>
